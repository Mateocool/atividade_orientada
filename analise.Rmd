...
```{r outros_anova, echo=FALSE, fig.cap="Figura 6. Fonte o autor, Porto Algre - RS, 2021"}
...
Após a análise dos resultados foi cálculado o percentual de eficiencia das diferentes prevenções contra pulgões, moscas brancas e lagartas em relação ao canteiro de controle utilizando a fórmula de Abbott, a qual pode ser conferida na seguinte equação:
...
#adicionar a efiencia contra os outros grupos tudo na mesma tabela
...
O canteiro S foi o que teve um menor número de pulgões na contagem das armadilhas, atingindo uma eficiencia de 64%, seguido de G e X com 24%, P e T. Contudo também foi observada quantidade aproximada de pulgões nas plantas e a diferênça de pulgões entre os canteiros, não foi significativa ao final dos 84 dias de testes. Até o final do segundo mês, sim existia uma diferênça, que a partir deste momento foi diminuindo.
